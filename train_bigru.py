...
# Import our dataset module and Bi-GRU model
...
def main():
    parser = argparse.ArgumentParser(description="Train Bi-GRU for Student Engagement Detection")
    ...
    # 2. Initialize Model
    print("Initializing Bi-GRU model...")
    ...
    history_path = checkpoint_dir / "bigru_history.json"
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if val_f1 > best_val_f1:
            best_val_f1 = val_f1
            best_epoch = epoch
            checkpoint_path = checkpoint_dir / "bigru_best.pth"
            torch.save({
                'epoch': epoch,
    ...
    final_path = checkpoint_dir / "bigru_final.pth"
