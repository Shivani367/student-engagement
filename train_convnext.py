...
# Import our dataset module and ConvNeXt1D model
...
def main():
    parser = argparse.ArgumentParser(description="Train ConvNeXt1D for Student Engagement Detection")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_f1 > best_val_f1:
            best_val_f1 = val_f1
            best_epoch = epoch
            checkpoint_path = checkpoint_dir / "convnext_best.pth"
            torch.save({
                'epoch': epoch,
    ...
    final_path = checkpoint_dir / "convnext_final.pth"
